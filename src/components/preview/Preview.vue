<template>
    ...
    <Window :show="windowShow" @close="closeWindow" :width="fileInfo.fileCategory == 1 ? 1300 : 900"
...
const imageUrl = computed(() => {
    console.log(proxy.globalInfo.imageUrl + fileInfo.value.fileCover.replaceAll("_.", "."))
    return (
